...
#
html_theme_options = {
    "base_url": "http://unifyingdatascience.org",
    "google_analytics_account": "UA-151397036-1",
    "html_minify": True,
    "css_minify": True,
    "globaltoc_depth": 1,
    ...
    "heroes": {"index": "Welcome to Unifying Data Science!"},
}
...
latex_documents = [
    (master_doc, "unifyingDS.tex", "Unifying Data Science", "Nick Eubank", "manual"),
]
...
man_pages = [(master_doc, "unifyingDS", "Unifying Data Science", [author], 1)]
