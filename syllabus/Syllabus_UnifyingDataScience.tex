...
Perhaps the hardest job of a data scientist is not answering a question, but coming up the with right question to ask in the first place. And so over the course of the semester, students will be repeatedly asked to practice generating tractable questions (and plans for answering those questions).

\emph{But wait, I thought the job of a data scientist was to make recommendations?}
...
\textbf{What question, if answered, would make deciding what to do next easy?}
